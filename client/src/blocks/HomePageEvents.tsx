                ...
                <div className="events-grid">
                    <div className="flier reveal">
                        ...
                        <div className="flier-meta">
                            ...
                            <div>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 21c-4.5-3.5-8-7-8-11a8 8 0 0 1 16 0c0 4-3.5 7.5-8 11Z"/><circle cx="12" cy="10" r="3"/></svg>
                    ...
                    <div className="last-event reveal">
                        ...
                        <div className="gallery-preview">
                            {/* <Link href="gallery.html"><Image height= "100" width= "100" src="https://picsum.photos/seed/thistle-event-a/700/900" alt="Apprentices chatting at the Glasgow summer meet-up"/></Link>
                            <Link href="gallery.html"><Image height= "100" width= "100" src="https://picsum.photos/seed/thistle-event-b/500/440" alt="Group photo from the summer meet-up"/></Link>
                            <Link href="gallery.html"><Image height= "100" width= "100" src="https://picsum.photos/seed/thistle-event-c/500/440" alt="Apprentices networking over drinks"/></Link> */}
                        </div>
