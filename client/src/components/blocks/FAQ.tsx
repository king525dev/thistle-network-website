                ...
                <div className="reveal">
                    <div className="faq">
                        <div className="faq-item open">
                            <button className="faq-q">Who can join? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg></button>
                        ...
                        <div className="faq-item">
                            <button className="faq-q">Is it free? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg></button>
                        ...
                        <div className="faq-item">
                            <button className="faq-q">Why {"can't"} I join WhatsApp directly? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg></button>
                        ...
                        <div className="faq-item">
                            <button className="faq-q">Can employers get involved? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg></button>
