        ...
        <footer>
            ...
            <div className="wrap foot-main">
                ...
                <div className="foot-social">
                    <a href="mailto:thistlenetwork@gmail.com" aria-label="Email"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M4 4h16v12H7l-3 3V4Z"/></svg></a>
